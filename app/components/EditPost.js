    ...
    switch (action.type) {
      ...
      case "titleRules":
        if (!action.value.trim()) {
          ...
          draft.title.message = "Blank titles are dull and thus inacceptable.";
        }
        return;
      case "bodyRules":
        if (!action.value.trim()) {
          draft.body.hasErrors = true;
          draft.body.message = "Blank body content is the worst!! Please fill something in.";
        }
        return;
      case "notFound":
        draft.notFound = true;
      ...
      try {
        ...
        if (response.data) {
          ...
          if (appState.user.username != response.data.author.username) {
            appDispatch({
              type: "flashMessage",
              value: "You can't edit somebody else's post."
            });
            navigate("/");
          }
        } else {
